...
const Applications = () => {
  ...
  const [isEdit, setIsEdit] = useState(false); // Controls edit mode
  const [resume, setResume] = useState(null); // Stores selected resume file

  const { backendUrl, userData, fetchUserData,userApplications,fetchUserApplications } = useContext(AppContext);

  // Debugging: Check if userData updates
  useEffect(() => {
          ...
          {isEdit || !userData?.resume ? (
            <>
              ...
              <button
                ...
                disabled={!resume} // Disabled if no file is selected
              >
                Save
              </button>
            </>
        ...
        <table className="min-w-full bg-white border rounded-lg">
          ...
          <tbody>
            {userApplications.map((job, index) => (
              <tr key={index}> {/* Add a unique key here */}
