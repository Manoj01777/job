    ...
    return (
        <div className="border p-6 shadow rounded">
            ...
            <div className="mt-4 flex gap-4 text-sm">
                ...
                <button onClick={()=>{navigate()}} className="text-gray-500 border border-gray-500 rounded px-4 py-2">
                    Learn more
                </button>
            </div>
        </div>
...
//Only use dangerouslySetInnerHTML when you can’t control the HTML content being inserted [for dyanmic html contents]
